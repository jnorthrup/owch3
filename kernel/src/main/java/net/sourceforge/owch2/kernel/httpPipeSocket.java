...
public class httpPipeSocket extends PipeSocket {
     ...
     */
    public httpPipeSocket(Socket socket, HasOrigin notification, HasOrigin request) {
        super(socket);
//        try {
//            Logger.getAnonymousLogger().info("using Notification : " + Notification.toString());
//
//            URI uri = URI.create(String.valueOf(Notification.getURI().toASCIIString() + request.get(AbstractAgent.RESOURCE_KEY)));
