...
//
///**
// * owchDispatch owch passes udp datagrams.  each of these datagrams was at one time a EventDescriptor.  dpwrap is created from
// * EventDescriptor.save(ByteArrayOutputStream).  dpwrap is held in a cache keyed by MessageID.
// *
